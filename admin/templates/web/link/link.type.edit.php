<div class="bjui-pageContent">
    <form action="index.php?a=yes&c=link.type&t=<?php echo $type;?>" data-reload="false" data-toggle="validate" method="post" <?php if($d) { echo 'data-callback="'.$cFun.'"';}?>>
	<input name="type_id" id="<?php echo $cFun.$type;?>type_id" type="hidden" class="input-text" value="<?php echo $id;?>">
		<fieldset>
			<legend>友链分类编辑</legend>
            ...
            <div class="tab-content">
            	<div class="tab-pane fade active in" id="<?php echo $cFun.$type;?>base">
					<table class="table table-border table-bordered table-bg table-sort">
					    ...
					    <tr>
					      <td valign="top"><b>分类跳转：</b></td>
					      <td valign="top"><input name="type[type_in_jump]" type="text" class="input-text" value="<?php echo C('type_in_jump',null,'data');?>" size="40"> 该分类下的友链点入跳转链接，默认为空</td>
						</tr>
					    <tr>
				...
				<div class="tab-pane fade" id="<?php echo $cFun.$type;?>templates">
					<table class="table table-border table-bordered table-bg table-sort">
					    <tr>
					      <td valign="top" width="150"><b>友链列表页模版：</b></td>
					      <td valign="top">
					      	<input id="type_tempid" name="type[type_tempid]" type="hidden" value="<?php echo C('type_tempid',null,'data');?>">
					      	<input id="temp_name" name="temp[temp_name]" type="text" value="<?php echo C('name',null,'temp');?>" data-toggle="lookup" data-url="index.php?c=system.templates.lookup&module=link&page=list&name=name&tid=tempid" data-title="选择当前友链分类列表页模版" size="15" data-width="700" data-height="500">
					      	<a class="btn btn-default" href="index.php?c=system.templates.edit&t=add&module=link&page=list&name=name&tid=tempid" data-toggle="dialog" data-title="上传新的友链列表页模版" data-width="540" data-height="450" ><i class="fa fa-cloud-upload">&nbsp;</i>上传模板</a>
					      </td>
						</tr>
					    <tr>
					      <td valign="top"><b>友链内容页模版：</b></td>
					      <td valign="top">
					      	<input id="type_ctempid" name="type[type_ctempid]" type="hidden" value="<?php echo C('type_ctempid',null,'data');?>">
					      	<input id="temp_cname" name="temp[temp_cname]" type="text" value="<?php echo C('cname',null,'temp');?>" data-toggle="lookup" data-url="index.php?c=system.templates.lookup&module=link&page=content&name=cname&tid=ctempid" data-title="选择当前友链分类内容页模版" size="15" data-width="700" data-height="500">
					      	<a class="btn btn-default" href="index.php?c=system.templates.edit&t=add&module=link&page=content&name=cname&tid=ctempid" data-toggle="dialog" data-title="上传新的友链内容页模版" data-width="540" data-height="450" ><i class="fa fa-cloud-upload">&nbsp;</i>上传模板</a>
					      </td>
						</tr>
					    <tr>
...
function <?php echo $cFun;?>(json){
	var op = linkTypeListGetOp();
	var tabid = 'link-type-list';
	op['id'] = tabid;

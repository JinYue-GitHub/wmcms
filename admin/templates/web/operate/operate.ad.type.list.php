...
<div class="bjui-pageHeader">
	<div class="row cl pt-10 pl-10">
		<div class="list-tool pl-15">
            <span >快捷操作：</span>
			<a href="index.php?a=yes&c=operate.ad.type&t=del" data-toggle="doajaxchecked" data-idname="ids" data-group="ids" data-confirm-msg="确定要删除选中项吗？" class="btn btn-danger size-MINI radius" data-callback="<?php echo $type.$cFun;?>ajaxCallBack"> <i class="fa fa-remove"></i> 批量删除</a>
			<a href="index.php?a=yes&c=operate.ad.type&t=clear" data-toggle="doajax" data-confirm-msg="此操作不可撤回确定要清空吗？" class="btn btn-danger size-MINI radius"><i class="fa fa-trash-o"></i> 清空记录</a>
		</div>
		<div class="list-tool">
...
<div class="bjui-pageContent">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			<thead>
				...
				<th width="5%" data-order-field="type_id">ID</th>
				<th width="20%">分类名</th>
				<th>分类描述</th>
	            <th width="15%">操作</th>
	            </tr>
			...
			if( $dataArr )
			{
				...
				foreach ($dataArr as $k=>$v)
				{
					...
					echo '<tr class="'.$cur.'">
							...
							<td style="text-align: center;">'.$v['type_info'].'</td>
							<td style="text-align: center;" data-noedit="true">
				            	<a class="btn btn-secondary radius size-MINI" data-toggle="dialog" data-mask="true" data-width="480" data-height="220" data-title="编辑广告分类" href="index.php?d=yes&c=operate.ad.type.edit&t=edit&id='.$v['type_id'].'">编辑</a> 
								<a class="btn btn-danger radius" onclick="'.$type.$cFun.'delAjax('.$v['type_id'].')">删除</a>
				            </td>
						</tr>';
					$i++;
				}
...
function <?php echo $type.$cFun;?>delAjax(id)
{
	...
	ajaxOptions['url'] = "index.php?a=yes&c=operate.ad.type&t=del";
	ajaxOptions['confirmMsg'] = "确定要删除所选的广告分类吗？";

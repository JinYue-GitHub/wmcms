	...
	<div class="row cl pt-10 pb-10 pl-10">
		<div class="f-l">
			<form id="pagerForm" name="<?php echo $cFun;?>Form" data-toggle="ajaxform" action="<?php echo $url;?>" method="post">
				...
				<a href="index.php?c=picture.type.edit&t=add" data-toggle="navtab" data-id="article-type-add" data-title="新增分类" data-width="350" data-height="330" class="btn btn-primary radius size-MINI"><i class="fa fa-plus"></i> 新增分类</a>
...
function <?php echo $cFun;?>delAjax(id)
{
	...
	ajaxOptions['url'] = "index.php?a=yes&c=picture.type&t=del";

...
<div class="bjui-pageHeader">
	<div class="row cl pt-10 pl-10">
		<div class="list-tool pl-15">
			...
			<a href="index.php?a=yes&c=novel.novel&t=del" data-toggle="doajaxchecked" data-idname="ids" data-group="ids" data-confirm-msg="确定要删除选中项吗？" class="btn btn-danger size-MINI radius" data-callback="<?php echo $cFun;?>ajaxCallBack"> <i class="fa fa-remove"></i> 批量删除</a>
		</div>
		<div class="list-tool">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			if( $dataArr )
			{
				...
				foreach ($dataArr as $k=>$v)
				{
					...
					switch ($v['novel_status'])
					{
						case '0':
							$status = '<a href="javascript:;" onClick="'.$cFun.'StatusAjax(1,'.$v['novel_id'].')"><span style="color:red">未审核</span></a>';
							break;
						case '1':
							$status = '<a href="javascript:;" onClick="'.$cFun.'StatusAjax(0,'.$v['novel_id'].')"><span style="color:green">已审核</span></a>';
							break;
						case '2':
							$status = '<a href="javascript:;" onClick="'.$cFun.'StatusAjax(0,'.$v['novel_id'].')"><span style="color:#AFAFAF">已拒绝</span></a>';
							break;
					}

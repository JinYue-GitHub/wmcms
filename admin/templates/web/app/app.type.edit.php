					...
					<table class="table table-border table-bordered table-bg table-sort">
					    <tr>
					      ...
					      <td valign="top">
					      	...
					      	<input id="temp_name" name="temp[temp_name]" type="text" value="<?php echo C('name',null,'temp');?>" data-toggle="lookup" data-url="index.php?c=system.templates.lookup&module=app&page=list&name=name&tid=tempid" data-title="选择当前应用分类列表页模版" size="15" data-width="700" data-height="500">
					      	<a class="btn btn-default" href="index.php?c=system.templates.edit&t=add&module=app&page=list&name=name&tid=tempid" data-toggle="dialog" data-title="上传新的信息列表页模版" data-width="540" data-height="450" ><i class="fa fa-cloud-upload">&nbsp;</i>上传模板</a>
					      </td>
						</tr>
					    <tr>
					      ...
					      <td valign="top">
					      	...
					      	<input id="temp_cname" name="temp[temp_cname]" type="text" value="<?php echo C('cname',null,'temp');?>" data-toggle="lookup" data-url="index.php?c=system.templates.lookup&module=app&page=content&name=cname&tid=ctempid" data-title="选择当前应用分类内容页模版" size="15" data-width="700" data-height="500">
					      	<a class="btn btn-default" href="index.php?c=system.templates.edit&t=add&module=app&page=content&name=cname&tid=ctempid" data-toggle="dialog" data-title="上传新的信息内容页模版" data-width="540" data-height="450" ><i class="fa fa-cloud-upload">&nbsp;</i>上传模板</a>
					      </td>
						</tr>
					    <tr>

	...
	<div class="row cl pt-10 pb-10 pl-10">
		<div class="f-l">
			<form id="pagerForm" name="<?php echo $cFun;?>Form" data-toggle="ajaxform" action="<?php echo $url;?>" method="post">
				...
				<a href="index.php?c=article.type.edit&t=add" data-toggle="navtab" data-id="article-type-add" data-title="新增分类" data-width="350" data-height="330" class="btn btn-primary radius size-MINI"><i class="fa fa-plus"></i> 新增分类</a>
...
function <?php echo $cFun;?>delAjax(id)
{
	...
	ajaxOptions['url'] = "index.php?a=yes&c=article.type&t=del";
	ajaxOptions['confirmMsg'] = "删除分类会删除分类下的子分类和文章，确定要删除分类吗？";
